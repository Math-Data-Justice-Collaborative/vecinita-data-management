...
class BaseServiceSettings(BaseSettings):
    ...
    scraper_service_url: str = Field("http://localhost:8001", alias="VECINITA_SCRAPER_API_URL")
    model_service_url: str = Field("http://localhost:8002", alias="VECINITA_MODEL_API_URL")
    embedding_service_url: str = Field("http://localhost:8003", alias="VECINITA_EMBEDDING_API_URL")
